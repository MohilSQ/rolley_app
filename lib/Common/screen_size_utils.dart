...
class SV {
  ...
  static setHeightRatio(double height) => ScreenUtil.instance.setHeight((SV.getHeight * height) - AppBar().preferredSize.height);
  static setWidthRatio(double width) => ScreenUtil.instance.setWidth(SV.getWidth * width);
